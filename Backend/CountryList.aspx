<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/Backstage.Master" AutoEventWireup="true" CodeBehind="CountryList.aspx.cs" Inherits="Tayana.Backend.CountryList" %>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">所有國家</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                     <div class="text-right mb-3">                       
                        <asp:Button ID="AddCountry_btn" runat="server" Text="新增國家" class="btn btn-primary" OnClick="AddCountry_btn_Click" ClientIDMode="Static" />
                    </div>
                    <asp:GridView ID="GridView1" CssClass="text-center w-100" runat="server" AutoGenerateColumns="False" DataKeyNames="country_id" Height="80px" ClientIDMode="Static" CellPadding="3" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdating="GridView1_RowUpdating" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                        <Columns>
