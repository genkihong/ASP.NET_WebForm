<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/Backstage.Master" AutoEventWireup="true" CodeBehind="AddYachtPhoto.aspx.cs" Inherits="Tayana.Backend.AddYachtPhoto" %>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-8">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">新增船型相簿</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-lightblue">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <img src="#" alt="" class="yacht_img img-fluid img-thumbnail" />
                            </div>
                        </div>
