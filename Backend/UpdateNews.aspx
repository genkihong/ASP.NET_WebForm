<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/Backstage.Master" AutoEventWireup="true" CodeBehind="UpdateNews.aspx.cs" Inherits="Tayana.Backend.UpdateNews" ValidateRequest="false" %>
                    ...
                    <div class="card card-lightblue">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group media">
                                <div class="media-body align-self-end mr-3">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <asp:FileUpload ID="news_img" class="custom-file-input" runat="server" ClientIDMode="Static" />
                                ...
                                <asp:Image ID="NewsImage" runat="server" class="news_img img-fluid img-thumbnail" ClientIDMode="Static" />
                            </div>
                            <%--日期--%>
                        ...
                        <div class="card-footer text-right">
                            ...
                            <asp:Button ID="UpdateNews_btn" runat="server" Text="確認" class="btn btn-primary" OnClick="UpdateNews_btn_Click" ClientIDMode="Static" />
                        </div>
                    </div>
                </div>
            </div>
